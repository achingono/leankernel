...
docker run --rm \
  ...
  bash -lc '
    ...
    dotnet sonarscanner begin \
      ...
      /d:sonar.cpd.exclusions="test/**,config/browser-service/**/*.py,src/LeanKernel.Tools/BuiltIn/Browser/BrowserToolDefinitions.cs,src/LeanKernel.Tools/BuiltIn/Data/*.cs,src/LeanKernel.Tools/BuiltIn/FileSystem/*.cs,src/LeanKernel.Host/Services/SelfConfigurationStep.cs,src/LeanKernel.Host/Services/UserConfigurationStep.cs,src/LeanKernel.Host/Templates/*.template" \
