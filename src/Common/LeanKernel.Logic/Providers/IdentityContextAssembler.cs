...
public sealed class IdentityContextAssembler(IOptions<IdentityClaimsContextSettings> settings)
{
    ...
    /// </summary>
    /// <param name="user">The user entity whose profile fields are rendered.</param>
    /// <returns>A formatted identity block string, or <c>null</c> when disabled or empty.</returns>
