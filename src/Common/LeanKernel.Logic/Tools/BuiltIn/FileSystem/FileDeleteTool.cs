...
{
    /// <summary>
    /// Creates a tool definition for deleting files or directories.
    /// </summary>
    /// <param name="scopeFactory">The service scope factory.</param>
    /// <returns>A <see cref="ToolDefinition"/> for the file delete tool.</returns>
    public static ToolDefinition Create(IServiceScopeFactory scopeFactory)
    {
        ...
        return new ToolDefinition
        {
            ...
            Handler = (args, ct) =>
            {
                ...
                if (fullPath is null)
                {
                    return Task.FromResult(new ToolResult { ToolName = "file_delete", Success = false, Error = Constants.FileSystem.Errors.PathOutsideAllowedDirectory });
                }
