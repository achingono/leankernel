...
namespace LeanKernel.Data.Migrations
{
    ...
    [Migration("20260720022555_AddScheduledJobs")]
            ...
            modelBuilder.Entity("LeanKernel.Entities.ScheduledJobEntity", b =>
                {
                    ...
                    b.HasIndex("TenantId", "ChannelId", "Name")
                        .IsUnique()
                        .HasFilter("\"TenantId\" IS NOT NULL AND \"ChannelId\" IS NOT NULL");

                    b.ToTable("ScheduledJobs", t =>
                        {
                            t.HasCheckConstraint("CK_ScheduledJobs_Scope", "\"TenantId\" IS NOT NULL OR \"ChannelId\" IS NOT NULL");
                        });
                });
