...
namespace LeanKernel.Data.Migrations
{
    ...
    [Migration("20260731182459_AddScheduledJobLeaseColumns")]
    partial class AddScheduledJobLeaseColumns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LeanKernel.Entities.DiagnosticEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LeanKernel.Entities.DocumentIngestionJobEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LeanKernel.Entities.EventEntity", b =>
                {
                    ...
                    b.HasIndex("RecordType", "CreatedOn", "Id");
            ...
            modelBuilder.Entity("LeanKernel.Entities.TurnTelemetryEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(50)
                    ...
                    b.Property<int>("GroundingStatus")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("RetrievedEvidenceClassesJson")
                        .HasColumnType("text");

                    b.Property<string>("RetrievedMemoryKeysJson")
                        .HasColumnType("text");
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "CreatedBy", "LeanKernel.Entities.TurnTelemetryEntity.CreatedBy#Badge", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "UpdatedBy", "LeanKernel.Entities.TurnTelemetryEntity.UpdatedBy#Badge", b1 =>
                        {
                            b1.Property<string>("Email")
                                .IsRequired()
                                .HasMaxLength(100)
                    ...
                    b.HasIndex("EvidenceClass");

                    b.HasIndex("GroundingStatus");

                    b.HasIndex("Provider");

                    b.HasIndex("ServedModel");

                    b.HasIndex("TurnId")
                        .IsUnique();

                    b.ToTable("TurnTelemetry");
                });
            ...
            modelBuilder.Entity("LeanKernel.Entities.UserEntity", b =>
                {
                    ...
                    b.Property<string>("CustomClaimsJson")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("LeanKernel.Entities.TurnTelemetryEntity", b =>
                {
                    b.HasOne("LeanKernel.Entities.TurnEntity", "Turn")
                        .WithMany()
