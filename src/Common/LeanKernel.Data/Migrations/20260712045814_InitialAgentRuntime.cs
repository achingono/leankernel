...
{
    /// <inheritdoc />
    public partial class InitialAgentRuntime : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ScopedConversationId = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AgentSessions", x => x.ScopedConversationId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedBy_Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    CreatedBy_Email = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    CreatedBy_FullName = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    UpdatedOn = table.Column<DateTime>(type: "TEXT", nullable: true),
                    UpdatedBy_Id = table.Column<Guid>(type: "TEXT", nullable: true),
                    UpdatedBy_Email = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    UpdatedBy_FullName = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SessionId = table.Column<Guid>(type: "TEXT", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AgentSessions_TenantId_UserId_ChannelId",
                table: "AgentSessions",
