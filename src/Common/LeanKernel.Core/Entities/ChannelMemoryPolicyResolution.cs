...
{
    /// <summary>
    /// Gets the tenant id used to resolve policy.
    /// </summary>
    public required Guid TenantId { get; init; }

    /// <summary>
    /// Gets the source channel id for this resolution.
    /// </summary>
    public required Guid ChannelId { get; init; }

    /// <summary>
    /// Gets channel ids that this source channel may read from.
    /// </summary>
    public required IReadOnlyCollection<Guid> ReadableChannelIds { get; init; }

    /// <summary>
    /// Gets channel ids that are mutually visible with the source channel.
    /// </summary>
