...
public sealed class ScopedKeyedAIAgentProxy(string agentName, IHttpContextAccessor httpContextAccessor) : AIAgent
{
    ...
    protected override ValueTask<AgentSession> CreateSessionCoreAsync(CancellationToken cancellationToken = default)
        => this.ResolveInnerAgent().CreateSessionAsync(cancellationToken);
    ...
    protected override ValueTask<JsonElement> SerializeSessionCoreAsync(
        ...
        => this.ResolveInnerAgent().SerializeSessionAsync(session, jsonSerializerOptions, cancellationToken);
    ...
    protected override ValueTask<AgentSession> DeserializeSessionCoreAsync(
        ...
        JsonSerializerOptions? jsonSerializerOptions = null,
        CancellationToken cancellationToken = default)
        => this.ResolveInnerAgent().DeserializeSessionAsync(serializedState, jsonSerializerOptions, cancellationToken);
    ...
    protected override Task<AgentResponse> RunCoreAsync(
        ...
        CancellationToken cancellationToken = default)
        => this.ResolveInnerAgent().RunAsync(messages, session, options, cancellationToken);
    ...
    protected override IAsyncEnumerable<AgentResponseUpdate> RunCoreStreamingAsync(
        ...
        AgentRunOptions? options = null,
        CancellationToken cancellationToken = default)
        => this.ResolveInnerAgent().RunStreamingAsync(messages, session, options, cancellationToken);
