...
public class OpenIdSettings
{
    ...
    /// <summary>
    /// Gets or sets optional explicit metadata address (authority discovery). Use to point to internal HTTP endpoint in dev.
    /// </summary>
    public string? MetadataAddress { get; set; }

    /// <summary>
    /// Gets or sets optional public origin used to build browser-facing redirects (e.g., http://localhost:8080).
