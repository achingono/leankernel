...
- Runtime and context: `context-gating.md`, `turn-pipeline.md`, `history-shaping.md`, `scoped-retrieval.md`, `knowledge-retrieval.md`, `model-routing.md`, `quality-gates.md`, `shadow-routing.md`, `response-enhancement.md`, `learning-pipeline.md`, `scheduler.md`, `multi-agent.md`, `long-running-tasks.md`
