...
## Gate Checklist
- [ ] Turns select a model via policy + complexity scoring, with escalation on failure/low quality.
...
- [ ] Unit + integration tests cover routing, shadow isolation, quality, enhancement, degradation, orchestration.
