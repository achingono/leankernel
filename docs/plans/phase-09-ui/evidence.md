...
| --- | --- | --- |
| Source chat UI | `~/source/repos/leankernel/src/LeanKernel.Gateway/Components/Pages/Chat.razor`, `Services/ChatService.cs` | Behavioral reference |
| Source diagnostics UI | `~/source/repos/leankernel/src/LeanKernel.Gateway/Components/Pages/Diagnostics.razor`, `Services/DiagnosticsService.cs` | Behavioral reference |
