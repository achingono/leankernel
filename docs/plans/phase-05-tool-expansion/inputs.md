...
| Input | Source | Owner |
|---|---|---|
| Phase 01 tool runtime | `src/Common/LeanKernel.Logic/Tools/*`, `src/Services/LeanKernel.Services.Gateway/Tools/*` | Rebuild maintainer |
| Filesystem boundary support | `src/Services/LeanKernel.Services.Gateway/Tools/BuiltIn/FileSystemSupport.cs` | Rebuild maintainer |
...
| Config shape | `src/Services/LeanKernel.Services.Gateway/Configuration/FileSettings.cs`, `docs/configuration/index.md` | Repository owner |
