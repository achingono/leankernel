...
| Target production files under test | `src/Services/LeanKernel.Services.Gateway/...`, `src/Common/LeanKernel.Logic/...` | Repository |
...
|---|---:|---:|
| `src/Services/LeanKernel.Services.Gateway/Memory/GBrainDocumentStoreClient.cs` | 90 | 4.4% |
| `src/Services/LeanKernel.Services.Gateway/Providers/AttachmentIngestionMiddleware.cs` | 82 | 10.1% |
| `src/Common/LeanKernel.Logic/Tools/DocumentIngestion/WatchFolderHostedService.cs` | 80 | 11.0% |
| `src/Services/LeanKernel.Services.Gateway/Requests/DocumentUploadEndpoint.cs` | 63 | 4.1% |
