...
| Input | Source | Owner |
|---|---|---|
| Memory scope + client | `src/Common/LeanKernel.Logic/Memory/MemoryModels.cs`, `src/Services/LeanKernel.Services.Gateway/Providers/GBrainMemoryClient.cs` (BuildScopedSlug/Namespace) | Rebuild maintainer |
...
| Isolation + permit | `src/Services/LeanKernel.Services.Gateway/Providers/{IdentityIsolationKeyProvider,RequestContextPermit}.cs`, `src/Common/LeanKernel.Core/Interfaces/IPermit.cs` | Rebuild maintainer |
