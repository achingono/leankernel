...
| LiteLLM route telemetry | `config/litellm/callbacks.py:89-108` (`record_route`: provider, model_id, api_base, response_model) | Rebuild maintainer |
...
- Phase 23 replay/eval harness (`docs/plans/phase-23-memory-eval-replay-harness/`) — telemetry consumer for regression scoring.
