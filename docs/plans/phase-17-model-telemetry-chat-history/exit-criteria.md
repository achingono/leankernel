...
- [x] Grounding/evidence-class labels are captured for each assistant turn and available in export/query surfaces.
...
- [x] Configuration (enable/disable, currency, retain-raw-metadata) validated at startup.
