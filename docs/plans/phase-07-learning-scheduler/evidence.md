...
| Rebuild memory conventions | `src/Common/LeanKernel.Logic/Providers/MemoryProvider.cs`, `src/Services/LeanKernel.Services.Gateway/Providers/GBrainMemoryClient.cs` | Scope-key convention |
