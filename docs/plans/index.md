...
| [browser-built-in-tool-playwright-service-reviewed-implementation-prd.md](browser-built-in-tool-playwright-service-reviewed-implementation-prd.md) | Capture the reviewed implementation plan for the Webwright browser tool delivery | Cross-model-reviewed implementation guardrails for browser service code, security, docs, and validation |
| [ui-ux-polish-playwright-remediation-prd.md](ui-ux-polish-playwright-remediation-prd.md) | Polish Gateway UI/UX based on Playwright exploration across the Docker Compose runtime | Reliable chat composition, consistent professional surfaces, accessible touch targets, and responsive page polish |
