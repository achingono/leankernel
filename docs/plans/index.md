...
**Recommended next phase** — highest value / lowest effort: self-contained schema + capture
path, foundation for model routing (04), learning (07), and spend guardrails (08).
