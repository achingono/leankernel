...
| Permit + isolation | `src/Common/LeanKernel.Core/Interfaces/IPermit.cs`, `src/Services/LeanKernel.Services.Gateway/Providers/{RequestContextPermit,IdentityIsolationKeyProvider}.cs` | Rebuild maintainer |
