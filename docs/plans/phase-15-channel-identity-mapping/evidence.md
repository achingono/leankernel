...
| Isolation/permit | `src/Services/LeanKernel.Services.Gateway/Providers/IdentityIsolationKeyProvider.cs`, `src/Common/LeanKernel.Core/Interfaces/IPermit.cs` | Reflects resolved user |
